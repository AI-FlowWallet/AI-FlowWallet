        ...
        <div className={`chat-message`}>
          <div className={cn("flex items-end")}>
            ...
            >
              ...
              >
                <p>
                Hello! I am the AI assistant for AI-FlowWallet. Our wallet currently supports two blockchain networks: OPBNB and BSC, and two digital assets: BNB and BUSD. I am here to assist you with any cryptocurrency-related questions and tasks.
                </p>
                <p>1. Execute secure transfers of BUSD and BNB to any specified address.</p>
                <p>2. Perform seamless swaps between BNB and BUSD across multiple chains.</p>
                <p>3. Instantly bridge BUSD between the OPBNB and BSC networks.</p>
              </div>
            </div>
